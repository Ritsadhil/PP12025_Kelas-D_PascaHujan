...
public class CRUD {
	...
	public void ambilData() {
		...
		listProduk = new Produk[maxIndex]; // Inisialisasi array setelah mengetahui jumlah data
	...
	public void TampilData() {
		...
		if (listProduk == null || listProduk.length == 0) {
			System.out.println("Data produk kosong.");
			return;
		}
		for (int i = 0; i < listProduk.length; i++) {
			if (listProduk[i] != null) {
				System.out.println((i + 1) + ". Kode: " + listProduk[i].getKode() +
						", Nama: " + listProduk[i].getNama() +
						", Kategori: " + listProduk[i].getKategori() +
						", Harga: Rp" + listProduk[i].getHarga());
			}
		}
		System.out.println("=============================================");
	}
